...
export const Skills = () => {
  ...
  const engineeringPillars = {
    ...
    devops: {
      ...
      badge: "DevOps & Continuous Delivery",
      description: "Automating production continuous deployment workflows, feature-branch Git workflows, Chrome DevTools performance profiling, and environment security.",
      features: [
        "Automated Cloud CI/CD: Continuous deployment pipelines with zero-downtime reliability",
        "Git & PR Workflows: Feature branching, atomic commits, and collaborative code reviews",
        "Lighthouse & Web Vitals: Performance audits, asset minification, and responsive testing",
        ...
        <div className="mt-12 p-6 rounded-2xl bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-emerald-500/10 border border-white/10 backdrop-blur-md">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="text-sm font-bold text-white">Full-Stack Velocity & Production Rigor</h4>
                <p className="text-xs text-slate-400">Crafting robust web architectures with predictable state, high testability, and zero-defect deployments.</p>
              </div>
            </div>
