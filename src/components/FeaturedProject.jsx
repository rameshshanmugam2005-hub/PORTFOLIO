...
<<<<<<< HEAD
                    ...
                    <button
                      ...
                      onClick={() => setActiveSimTab('architecture')}
                      className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold transition-all cursor-pointer ${
                    ...
                    <div className="p-6 sm:p-8 space-y-6 animate-in fade-in duration-200">
                      <div>
                        ...
                        <h4 className="text-base sm:text-lg font-bold text-white">
                          End-to-End Transit Telemetry Pipeline
                        </h4>
                        <p className="text-xs text-slate-300 mt-1 leading-relaxed">
                          Transit AI connects a high-performance modern web frontend to an Express REST backend with sub-second polling and asynchronous JSON serialization.
                        </p>
                      </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        <div className="p-3.5 rounded-xl bg-blue-500/10 border border-blue-500/20 text-center space-y-1">
                          <span className="text-[10px] font-mono font-bold text-blue-400 uppercase">Tier 1: Client UI</span>
                          <h5 className="text-xs font-bold text-white">Browser SPA (ES6+)</h5>
                          <p className="text-[11px] text-slate-300">Asynchronous polling worker, dynamic vehicle map, visual occupancy gauges.</p>
                        </div>

                        <div className="p-3.5 rounded-xl bg-purple-500/10 border border-purple-500/20 text-center space-y-1">
                          <span className="text-[10px] font-mono font-bold text-purple-400 uppercase">Tier 2: Backend API</span>
                          <h5 className="text-xs font-bold text-white">Node.js & Express</h5>
                          <p className="text-[11px] text-slate-300">RESTful route handlers, AI query intent router, QR token cryptographic verification.</p>
                        </div>

                        <div className="p-3.5 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-center space-y-1">
                          <span className="text-[10px] font-mono font-bold text-emerald-400 uppercase">Tier 3: Cloud & Deploy</span>
                          <h5 className="text-xs font-bold text-white">Scalable Cloud Architecture</h5>
                          <p className="text-[11px] text-slate-300">Automated continuous deployment, zero downtime, and SSL encrypted production endpoints.</p>
                        </div>
                      </div>

                      {/* Live REST Endpoints List */}
                      <div className="space-y-2">
                        <span className="text-xs font-mono font-semibold text-slate-300 uppercase tracking-wider block">
                          Engineered REST API Endpoints
                        </span>
                        
                        <div className="space-y-2">
                          <div className="p-2.5 rounded-lg bg-slate-900/90 border border-white/10 flex items-center justify-between gap-2 font-mono text-xs">
                            <div className="flex items-center gap-2">
                              <span className="px-2 py-0.5 rounded bg-emerald-500/20 text-emerald-400 font-bold text-[10px]">GET</span>
                              <span className="text-white">/api/telemetry/routes</span>
                            </div>
                            <span className="text-slate-400 text-[11px] hidden sm:inline">Returns active buses, GPS coordinates & 2.5s ETA</span>
                          </div>

                          <div className="p-2.5 rounded-lg bg-slate-900/90 border border-white/10 flex items-center justify-between gap-2 font-mono text-xs">
                            <div className="flex items-center gap-2">
                              <span className="px-2 py-0.5 rounded bg-emerald-500/20 text-emerald-400 font-bold text-[10px]">GET</span>
                              <span className="text-white">/api/occupancy/gauge</span>
                            </div>
                            <span className="text-slate-400 text-[11px] hidden sm:inline">Real-time crowd congestion & seat density payload</span>
                          </div>

                          <div className="p-2.5 rounded-lg bg-slate-900/90 border border-white/10 flex items-center justify-between gap-2 font-mono text-xs">
                            <div className="flex items-center gap-2">
                              <span className="px-2 py-0.5 rounded bg-blue-500/20 text-blue-400 font-bold text-[10px]">POST</span>
                              <span className="text-white">/api/assistant/query</span>
                            </div>
                            <span className="text-slate-400 text-[11px] hidden sm:inline">Parses natural language transit queries & route changes</span>
                          </div>

                          <div className="p-2.5 rounded-lg bg-slate-900/90 border border-white/10 flex items-center justify-between gap-2 font-mono text-xs">
                            <div className="flex items-center gap-2">
                              <span className="px-2 py-0.5 rounded bg-blue-500/20 text-blue-400 font-bold text-[10px]">POST</span>
                              <span className="text-white">/api/tickets/generate</span>
                            </div>
                            <span className="text-slate-400 text-[11px] hidden sm:inline">Generates verified cryptographic digital QR boarding pass</span>
                          </div>
                        </div>
                      </div>
                    </div>
